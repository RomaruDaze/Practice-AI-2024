...
| オントロジー名                 | 対象とした新製品                                                                              |
| :----------------------------- | :-------------------------------------------------------------------------------------------- |
| あらゆる種類の機械オントロジー | 3D プリンター、CNC マシン、レザーカッター、PCB プリンター、掘削機、グラインダー、テーブルソー |
...
<img src="./assets/protege-sparql.png" alt="オントロジファイル" width="50%" border="1">
<img src="./assets/protege-sparql2.png" alt="オントロジファイル" width="50%" border="1">
...
<img src="./assets/sparql-annopro.png" alt="オントロジVirtuoso" width="30%" border="1">
